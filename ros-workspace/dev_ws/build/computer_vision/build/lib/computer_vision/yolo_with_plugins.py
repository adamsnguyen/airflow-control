...
sys.path.append('/workspace/dev_ws/include/libyolo_layer.so')


try:
    ctypes.cdll.LoadLibrary('/workspace/dev_ws/include/libyolo_layer.so')
except OSError as e:
...
class TrtYOLO(object):
    ...
    def _load_engine(self):
        os.chdir("/workspace/dev_ws/include/")
