...
: ${AMENT_CURRENT_PREFIX:="/workspace/dev_ws/install/modbus_rtu"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/modbus_rtu/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/modbus_rtu/environment/path.sh"
