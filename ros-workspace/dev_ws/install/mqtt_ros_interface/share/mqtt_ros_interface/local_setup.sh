...
: ${AMENT_CURRENT_PREFIX:="/workspace/dev_ws/install/mqtt_ros_interface"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/mqtt_ros_interface/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/mqtt_ros_interface/environment/path.sh"
